...
\section{Ambiente de Desenvolvimento}
	...
	\subsection{Ferramenta CASE para Banco de Dados}
		...
		\subsubsection{PowerDesigner}
			...
			O PowerDesgine possui destaque no mercado de arquitetura de dados sendo umas das ferramentas mais utilizadas em
...
\section{Ambiente de Gerenciamento}
	\subsection{Construção de Software}
		...
		\subsubsection{Maven}
			Ferramenta para automatizar construção de software, escrita em Java sob licença Apache 2.0, tipicamente utilizada
			para projetos java. Construção baseada em XML. Permite definir as dependencias da aplicação e deixar o maven
			baixar-las automaticamente de um repositório.
