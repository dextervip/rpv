...
\chapter{INTRODUÇÃO}
	...
	\section{Pip}
		...
		Devido à grande quantidade de extensões, bibliotecas e frameworks que utilizam o Python, a comunidade dessa linguagem criou um repositório centralizado de pacotes, o Python Package Index.
	...
	\section{Jenkins}
				...
				realizar a construção com ajuda do Maven\cite{MAVENBUILDTOOL} ou Ant\cite{ANTBUILDTOOL}, realizar a execução dos testes e fazer o deploy para o servidor de
