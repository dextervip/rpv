...
\chapter{SPRINT}
		...
		Esta seção aborda as informações sobre o Sprint II, demonstrando o nosso sprint backlog logo a baixo.\ldots
...
\section{Acesso ao Gestor de Projeto}
	
	O gestor de projeto pode ser acessado através da url: \url{http://redmine.vsnetwork.net/projects/rp-v} , o qual está visívelmente público em todas as atividades.
