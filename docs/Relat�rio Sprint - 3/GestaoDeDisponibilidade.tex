...
\chapter{SPRINT}
	...
	\section{User Story 1}
		...
		\begin{figure}[h]
			\begin{center}
				 ...
				 \caption{Diagrama de Caso de Uso - Dias de Ausência}
	...
	\section{User Story 3}
		...
		\subsection{Diagramas de Caso de Uso}
			\begin{figure}[h]
				\begin{center}
				 \includegraphics[width=400px]{CasoUsoUserStory3}
				 \caption{Diagrama de Caso de Uso - User Story 03}
				 \label{fig:CasoUsoUserStory3}
				\end{center}
			
				\begin{center}
				 \includegraphics[width=400px]{CasoUsoAreaFormacao}
	...
	\clearpage
			...
			\begin{figure}[h]
				\begin{center}
			\includegraphics[width=500px]{SequenceGradeAulas}
			\caption{Diagrama de Sequência - Grade de Aulas}
			\label{fig:SequenceGradeAulas}
				\end{center}
			
				\begin{center}
			\includegraphics[width=500px]{SequenceInteresseDisciplina}
	...
	\clearpage
		\begin{figure}[h]
		\begin{center}
			\includegraphics[width=500px]{SequenceAreaFormacao}
	...
	\section{Diagrama de Classes}
		...
		A figura \ref{fig:DiagramaClassesModelo} mostra o diagrama de classes da solução implementada para as \emph{user stories} do \emph{sprint}.
	
		\begin{figure}[h]
			\begin{center}
				 \includegraphics[width=500px]{DiagramaClassesModelo}
