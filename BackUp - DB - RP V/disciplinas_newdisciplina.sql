...
INSERT INTO `disciplinas_newdisciplina` (`id`, `nome`, `codigo`, `curso`, `campus`, `cargaHora`, `creditosPraticos`, `creditosTeoricos`, `anoLetivo`, `turno`, `turma`, `ementa`, `objetivosGeral`, `preRequisitos`, `bibliograBasica`, `bibliograComplem`) VALUES
